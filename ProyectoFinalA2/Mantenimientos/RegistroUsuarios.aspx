...
--%>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <asp:TextBox ID="NamesTextBox" runat="server" 
                            Class="form-control input-sm"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RFVNames" runat="server" MaxLength="200" 
                ...
                <%--UserName--%>
                <div class="form-group">
                    <label for="UsernameTextBox" class="col-md-3 control-label input-sm">Nombre de Usuario</label>
                    <div class="col-md-8">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" MaxLength="200" 
                            ...
                            Display="Dynamic" SetFocusOnError="True" 
                            ToolTip="Campo Username obligatorio">Por favor llenar el campo Username
                        </asp:RequiredFieldValidator>
                    </div>
                </div>
                <%--Pass--%>
